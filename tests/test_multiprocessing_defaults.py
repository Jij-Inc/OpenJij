...
try:
    ...
    print("✓ SASampler.get_default_num_threads() works correctly")
    ...
    print("✓ SASampler initialization works correctly")
    ...
    print("✓ sample_qubo with defaults works correctly")
    ...
    print("✓ sample_qubo with explicit values works correctly")
