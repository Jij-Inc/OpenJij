...
class QUIOTest(unittest.TestCase):
    ...
    def test_quio_integer_optimal_2(self):
        Q = {(0, 0): 2.0, (1, 1): 3.0, (2, 2): 1.0, (0, 1): -6.0, (0, 2): 2.0}
        bound_list = {0: (-1, 2), 1: (-2, 1), 2: (0, 3)}
    ...
    def test_quio_integer_corner_case_1(self):
        Q = {}
        bound_list = {}
