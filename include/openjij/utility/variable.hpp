...
struct IntegerVariable {
   ...
   void SetRandomValue(RandomNumberEngine &random_number_engine) {
      this->value = std::uniform_int_distribution<std::int64_t>(this->lower_bound, this->upper_bound)(random_number_engine);
   }
   ...
   std::int64_t GenerateCandidateValue(RandomNumberEngine &random_number_engine) const {
      std::int64_t candidate_value = std::uniform_int_distribution<std::int64_t>(this->lower_bound, this->upper_bound - 1)(random_number_engine);
   ...
   std::int64_t GenerateRandomValue(RandomNumberEngine &random_number_engine) const {
      return std::uniform_int_distribution<std::int64_t>(this->lower_bound, this->upper_bound)(random_number_engine);
   }
